...
1. DATA EXPLORATION (1_initial.sql)
...
2. DRIVER ANALYSIS (2_driver_analysis.sql)
...
3. CONSTRUCTOR ANALYSIS (3_constructor_analysis.sql)
...
4. QUALIFYING AND PITSTOP ANALYSIS (4_quali_and_pitstop_analysis.sql)
...
5. ADVANCED QUERIES (5_advanced_queries.sql)
