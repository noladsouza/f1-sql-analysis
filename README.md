...
## Key Findings
- Pole position delivers an 82.98% podium rate vs just 1.35% 
  for drivers starting outside the top 10
- Mercedes has the highest all-time win rate at 19.27%, despite 
  Ferrari having the most total wins (250)
- Lewis Hamilton leads career wins (106), points (5,069.5) 
  and pole positions (105)
- Ferrari's worst modern season was 2020 — averaging P8.82 
  finishes and only 7.71 points per race
- Drivers starting P1 average a P2.41 finish across all races 
  since 1950
